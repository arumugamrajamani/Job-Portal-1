...
<body>
    ...
    <div class="sidebar shadow-lg" id="mySidebar" class="sidebar">
        <div class="menu">
            ...
            <div class="item"><a href="jobcategories-management.php" class="highlight"><img class="me-3" src="image/jobcategory.png" id="cate"> Job Categories Management</a><br></div>
            <div class="item">
