...
<br><br><br>
          <div  style="width: 1450px; height: 800px; margin-left: 390px;" class="container-fluid p-md-5 mt-4 bg-white">
            <form class="d-flex">      
              <input id="search" style="border-radius: 0%; border-top-left-radius: 10px; border-bottom-left-radius: 10px; width: 300px;" class="form-control icon" type="search" placeholder="Search a jobseeker" aria-label="Search">
  ...
  <div class="modal fade" id="deleteJobseeker" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title ms-5" id="exampleModalLabel">Are you sure you want to delete</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
