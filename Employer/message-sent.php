...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
        <div class="container-fluid"> 
			...
			<img src="image/flogo.png" onclick="window.location.href='company-profile.php'" alt="Job Portal Logo" width="100" height="70" id="logo"></a>
	...
	<div class="d-flex mt-5 ms-5">
		<div class="container con1 bg-white shadow " >
			...
			<div class="block">
				<div class="d-flex">
					<button class="mt-4 btn1 mb-4 ms-3" id="submit" onclick="location.href='message-employer.php'" > 
						<div class="d-flex">
