	...
	<div class="d-flex mt-5 ms-5">
				...
				<div class="d-flex">
					...
					<button class="mt-4 btn1 mb-4 ms-3 highlight" id="submit">
						<div class="d-flex">
							...
							<h6 class="mt-2 ps-2 job">JOB MESSAGES</h6>
						</div>
					</button>
				</div>
		...
		<div class="container-md bg-white shadow p-0 con3">
			<div class="con2 row col-lg-12">
				<div class="col-lg-5">
					<button class="return" type="submit">
						<img src="image/arrow-left.png" class="mt-3" alt="" width="35px" height="30px" onclick="location.href='message-jobseekers.php'">
					</button>
				</div>
				<div class="col-lg-7 mt-3 c3">
					<h4>New Message</h4>
				</div>
			</div>
			...
			<div class="col-lg-12 mt-3 ms-5 d-flex">
				<div class="col-6 c6">
					<textarea class="form-control reply pt-5 reply" placeholder="Type a reply" rows="4"></textarea>
				</div>
