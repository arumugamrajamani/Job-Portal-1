				...
				<div class="form-check">
					...
					<section class="sec1">
						<div class="d-flex pt-3">
							...
							<p class="mt-2 ms-4 p2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo, consequuntur! Ad cum placeat temporibus, <br> officia minima voluptate beatae voluptates veniam.</p>
						</div>
					</section>
				</div>
				<div class="form-check">
