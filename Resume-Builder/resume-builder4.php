...
<head>
    ...
    <link rel="stylesheet" href="/Resume-Builder/css/resume-builder4.css">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item account dropdown active">
                ...
                <ul class="dropdown-menu account-drop" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item logout text-light" href="/reset-password.php">CHANGE PASSWORD</a></li>
