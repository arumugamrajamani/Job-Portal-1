...
<div class="color-overlay">
                    ...
                    <ul class="navbar-nav ms-auto text-center">
                        <nav class="navbar navbar-light ">
                            ...
                            <li class="nav-item dropdown me-3">
                                <a class="nav-link dropdown-toggle fs-5 me-3" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Signup</a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="nav-link fs-5 me-5" href="login.php">Login</a></li>   
                        </nav>
                    </ul>
                </div>
            </nav>         
    ...
    <br>
    <div class="container" style="width:1060px;height: 1875px;background-color: #FDF6EC;">
