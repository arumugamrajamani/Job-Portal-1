...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2022 at 12:39 PM
...
--
ALTER TABLE `applied_jobs`
  ADD CONSTRAINT `employer_id3` FOREIGN KEY (`employer_id`) REFERENCES `employer` (`employer_id`),
  ADD CONSTRAINT `jobseeker_id3` FOREIGN KEY (`jobseeker_id`) REFERENCES `jobseeker` (`jobseeker_id`),
  ADD CONSTRAINT `post_id` FOREIGN KEY (`post_id`) REFERENCES `jobpost` (`post_id`);
