    ...
    <div class="color-overlay">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg  h6 navbar-light bg fixed-top mx-0">
                ...
                <img src="image/logo.png" alt="Job Portal Logo" width="120" height="95"></a>
    ...
    <div class="container-responsive">
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Adrian T. Palagasan</h5>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Marc John B. Castillo</h5>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Angelo Kenneth R. Arrojo</h5>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Adiran S. Nunag</h5>
                    <p class="card-text">Documentation</p>
                </div>
            </div>
        </div>
