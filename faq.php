...
<body>
    ...
    <div class="masthead" style="background-image: url('./image/fbg1.png');">
    		...
    		<div class="input-group form-container ">
            	...
            	<span class="input-group-btn">
            		<button class="btn btn-search">
            			<img src="image/searchlogo.png" width="40">
    	...
    	<br><br>
    	<div class="container">
      		<img class="img1"src="image/jobicon.png" width="40">
      		<span class="faq1 align-baseline fs-4">FOR JOBSEEKER</span>
      		<img class="img2"src="image/employicon.png" width="40">
      		<span class="faq2 align-baseline fs-4">FOR EMPLOYER</span>
