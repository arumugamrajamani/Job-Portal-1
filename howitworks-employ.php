...
<head>
    ...
    <link rel="stylesheet" href="css/howitworks-employ.css">
    ...
    <div class="container mb-5 shadow" style="background-color: #FDF6EC;height:100vh;border-radius: 20px;"><br>
        ...
        <div class="d-block ms-5">
            <div class="d-flex ms-5">
                <img src="image/step1.png" alt="" class="mt-5 mb-3" style="margin-left:200px;width: 150px; height: 150px;">
                <div class="block ms-5 mt-5">
                    <h4 class="fw-bold">Step 1</h4>
                    <p> Post a Job or Search Resumes</p>
                    <h4 class="fw-bold">Search Resumes</h4>
                    <p> Proactively look for staff with the skills you need</p>
                    <span class="input-icons"><i class="bi bi-search pt-1 ms-2" style="font-size: 20px;" ></i>
                        <input class="form-control me-2 ps-5" style="background-color: #ECECEC; width: 430px;border: 0;" type="search" placeholder="Search" aria-label="Search">
                    </span>
                </div>
            </div>
            <div class="d-flex ms-5">
                <img src="image/step2.png" alt="" class="mt-5 mb-3" style="margin-left:180px;width: 150px;">
                <div class="block mt-5" style="margin-left: 67px;">
                    <h4 class="fw-bold" id="step2">Step 2</h4>
                    <div class="d-flex">
                        <img src="image/check.png" alt="" style="width:35px; height:35px;">
                        <p class="mt-2"> Find the perfect staff member</p>
                    </div>
                    <div class="d-flex">
                        <img src="image/check.png" alt="" style="width:35px; height:35px;">
                        <p class="">Communicate with them via simple email</p>
                    </div>
                    <div class="d-flex">
                        <img src="image/check.png" alt="" style="width:35px; height:35px;">
                        <p class="">Interview them like you would for a normal staff member</p>
                    </div>
                    <div class="d-flex">
                        <img src="image/check.png" alt="" style="width:35px; height:35px;">
                        <p class=""> Find the perfect fit.</p>
                    </div>
                </div>
            ...
            <div class="d-flex ms-5">
                <img src="image/step3.png" alt="" class="mt-5 mb-3" style="margin-left:180px;width: 150px;">
                <div class="block mt-5" style="margin-left: 67px;">
                    <h4 class="fw-bold" id="step2">Step 3</h4>
                    <div class="d-flex">
                        <img src="image/check.png" alt="" style="width:35px; height:35px;">
                        <p class="mt-2"> Find the perfect staff member</p>
                    </div>
