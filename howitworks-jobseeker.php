...
<body>
    ...
    <div class="container mb-5 shadow" style="background-color: #FDF6EC;height:100vh;border-radius: 20px;"><br>
        ...
        <section class="ms-5" style="background-color: rgba(0, 194, 214, 0.33);box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);height:150px;width: 93%;">
            <p style="font-size: 22px;" class="text-center p-4 px-5">With today's technology, it is super easy to be hired by companies and 
        ...
        <div class="d-flex ms-5 mt-5">
            <div class="block ms-5">
                <div class="ms-4">
                    <img src="image/job.png" alt="" style="width:280px;height:180px;">
                
                </div>
                <div class="ms-4 mt-5">
                    <img src="image/men.png" alt="" style="width:200px;height:200px;">
            ...
            <div class="row">
				<div class="col-md-2 mx-auto mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="my-0"><a href="#" class="text-dark" style="text-decoration: none;">How it works</a></li>
                    </ul>
                </div>
                <div class="col-md-2 mx-auto mb-4">
                    <h6 class="text-uppercase fw-bold">EMPLOYER</h6>
