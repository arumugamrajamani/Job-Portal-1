...
<head>
    ...
    <link rel="stylesheet" href="css/howitworks-jobseeker.css">
...
<body>
    ...
    <div class="container mb-5 shadow con1"><br>
        <h3 class="fw-bold mt-5 text-center">How it Works</h3><br>
        <section class="ms-5 sec1">
            <p class="today text-center p-4 px-5 fs-4">With today's technology, it is super easy to be hired by companies and 
                then do the job from the comfort of your own home with your family. At
                Tech-Ployment we'll help you explore online job opportunities and earn
                a living. Here are the 5 easy steps in applying your dream job!</p>
        </section>
        <div class="ms-5 mt-5">
            <div class="block ms-5">
                <div class="ms-4">
                    <img src="image/job.png" alt="" class="img1">
                
                </div>
                <div class="ms-4 mt-5">
                    <img src="image/men.png" alt="" class="img1">
                
                </div>
            </div>
            <div class="step">
                <h4 class="fw-bold">STEP 1</h4>
                <p> Once you have an account, click the job board button</p>
                <h4 class="fw-bold">STEP 2</h4>
                <p> On the side panel, you can customize the type of job that you are looking</p>
                <h4 class="fw-bold">STEP 3</h4>
                <p> If you found the perfect job, click apply now!</p>
                <h4 class="fw-bold">STEP 4</h4>
                <p> 
                    Supply the require informations such as your contact number, 
                    resume or email
                </p>
                <h4 class="fw-bold">STEP 5</h4>
                <p>  Wait for the reply of the employer and be ready to be hired!</p>
                
            </div> 
        </div><br><br><br>
        <p class="text-center">Got more questions? visit our <a href="index.php#faq">FAQ</a> page!</p>
        ...
        <div class="container-fluid text-start text-md-left mt-5 px-5">
            <div class="row">
                ...
                <div class="col-md-2 col-lg-2 g-0 mx-auto mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="my-0"><a href="companyregister.php" class="text-dark">Developer</a></li>
                        <li class="my-0"><a href="companyregister.php" class="text-dark">Iconscout</a></li>
                        <li class="my-0"><a href="howitworks-employ.php" class="text-dark">Flaticon</a></li>
                        <li class="my-0"><a href="howitworks-employ.php" class="text-dark">Web icons</a></li>
                    </ul>
                </div>
                <div class="col-md-2 col-lg-2 mx-auto mb-4 text-center">
                    <h6 class="contact-us text-uppercase">CONTACT US</h6>
                    <ul class="contact-me list-unstyled">
