...
<div class="container-fluid">
    <nav id="navbar-example2" class="navbar navbar-expand-lg navbar-light fixed-top shadow " >
        <div class="navbar-brand">
            <img src="image/light-logo.png" width="75" height="77" alt="Job Portal Logo" class="flogo" id="logos">
        </div>
        ...
        <div class="collapse navbar-collapse" id="toggleMobileMenu">
            <ul class="navbar-nav ms-auto text-center fw-bold">
                <nav class="navbar navbar-light">     
                    <li><a class="nav-link me-5" href="<?php if ($page == "index.php") echo '#home'; else echo 'index.php#home'; ?>">Home</a></li>
                    <li><a class="nav-link me-5" href="<?php if ($page == "index.php") echo '#aboutus'; else echo 'index.php#aboutus'; ?>">About Us</a></li>
                    <li><a class="nav-link me-5" href="<?php if ($page == "index.php") echo '#contactus'; else echo 'index.php#faq'; ?>">Contact Us</a></li>
                    <li><a class="nav-link me-5" href="<?php if ($page == "index.php") echo '#faq'; else echo 'index.php#faq'; ?>">FAQ</a></li>
