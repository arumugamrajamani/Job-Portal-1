                        ...
                        <nav class="navbar navbar-light ">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item me-4 fs-5" href="companyregister.html">Employer</a></li>
 								<li><a class="dropdown-item me-4 fs-5"href="signup.html">JobSeeker</a></li>
                            </ul>
    ...
    <div class="masthead" style="background-image: url('./image/fbg1.png');">
            ...
            <div class="container">
                ...
                <div class="text-center">
                    <button type="button" onclick="location.href='findajob.html'" class="btn btn-outline-secondary btn-sm fs-6">Browse All Job Post </button>
