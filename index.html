...
<body>
                ...
                <div class="collapse navbar-collapse" id="toggleMobileMenu">
                    <ul class="navbar-nav ms-auto text-center">
                        ...
                        <nav class="navbar navbar-light ">
                            <li><a class="nav-link me-5 fs-5" href="contactus.html">ContactUs</a></li>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item me-4 fs-5" href="signup.html">Employer</a></li>
 								<li><a class="dropdown-item me-4 fs-5"href="signup1.html">JobSeeker</a></li>
                            </ul>
    ...
    <div class="masthead" style="background-image: url('./image/fbg1.png');">
            ...
            <div class="container">
                ...
                <div class="text-center">
                    <button type="button" class="btn btn-outline-secondary btn-sm fs-6">Browse All Job Post</button>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="card me-5" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-outline-secondary">Apply Now</a>
    ...
    <div class="para"><br>
        ...
        <p class="text-center fs-5"> We are Melham Construction Corporation interns who want to create <br> a
                        			website for available jobs online. The traditional method of applying for <br>jobs has been
                        			innovated, and on this page we offer a minimalist, clean,<br> and simple to use website for both
                        			job seekers and employers.<br> Tech-Ployment is a combination of technology and employment in
                        			which <br>employability is now empowered by our modern technology.</p><br>
                
    </div>
    	<br><br><br><br>
    <div class="para2"> <br>
               
        <div class="position fs-5">
            <h4>Our Services</h4>
            <p>We serve individuals by connecting employers with workers who are looking for jobs.<br> We want to instill confidence in everyone's outsourcing experience.</p><br>
            <h4>Why we do it</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-2 mx-auto mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="my-0"></i> <a href="#">Contact us</a></li>
