...
<body>
                ...
                <div class="collapse navbar-collapse" id="toggleMobileMenu">
                    <ul class="navbar-nav ms-auto text-center">
                        <nav class="navbar navbar-light ">
                            <li>
                                <a class="nav-link me-5 fs-5" href="#aboutus">About Us</a></li>
                                <a class="nav-link me-5 fs-5" href="#contactus">Contact Us</a></li>
                                <a class="nav-link me-5 fs-5" href="#faq">FAQ</a></li>
                                <a href="searchjob.html">
                                <button class="btn btn-outline-secondary me-5 fs-5 text-dark" type="button">Find a Job</button></a>
                                <button class="btn btn-outline-secondary me-5 fs-5 text-dark" type="button">Post a Job</button>
    ...
    <div class="masthead" style="background-image: url('./image/fbg1.png');">
                <br><br><br><br>
            <div class="container">
                        <h1 class="text-center mt-5">EMPLOYMENT POWERED BY TECHNOLOGY </h1>
                        
                        <p class="text-center fs-5">Are you sick of standing in endless lines? Today, technology gives you an advantage in the job market <br> by allowing you to apply with a single click and from the comfort of your home. <br> Now is the time to apply! Use <strong> Tech-Ployment  </strong>and get your first online job!</p>
                        <br>
                <div class="col-md-6 col-lg-6 col-11 mx-auto my-auto search-box">

                    <div class="input-group form-container ">
                            <input type="text" name="search" class="form-control search-input" placeholder="Search a Job" autofocus="autofocus" autocomplete="off">
                            <span class="input-group-btn">
                                <button class="btn btn-search"> <img src="image/searchlogo.png" width="40"></button>
                            </span>
                    </div>
                ...
                <div class="text-center">
                    <button type="button" onclick="location.href='searchjob.php'" class="btn btn-outline-secondary btn-sm fs-6 text-dark">Browse All Job Post </button>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="card me-5" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text">We're looking for a Web developer.</p>
                            <a href="#" class="btn btn-outline-secondary text-dark">Apply Now</a>
                    ...
                    <div class="card me-5 " style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text">We're looking for a Customer support specialist.</p>
                            <a href="#" class="btn btn-outline-secondary text-dark">Apply Now</a>
                    ...
                    <div class="card me-5" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text">We're looking for a talented Virtual Assistant.</p>
                            <a href="#" class="btn btn-outline-secondary text-dark">Apply now</a>
...
<section id="aboutus" style="background:#FDF6EC;">
        <br><br><br>
        <div class="aboutus-bg mb-3 shadow" style="width: 250px; height:80px; background:#00C2D6; margin-left: 820px; border-radius: 20px;">
        <h4 class="text-center pt-4 mt-5">About Us</h4><br>
        </div><br>

    <div class="para ms-5 shadow pb-5" style="width: 95%;"><br>
                
        <h3 class="text-center" style="color: #372732;text-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25), 0px 4px 4px rgba(0, 0, 0, 0.25);">Meet Our Team</h3><br>
    	...
    	<br><br><br><br>
    <div class="para2 ms-5 shadow" style="width: 95%;"> <br>
        <div class="fs-5 ms-4" style="color: #372732;font-family: 'Inter';">
            ...
            <h4 class="fw-bold">Why we do it</h4>
...
<div class="con0" id="contactus" style="background-color: #FDF6EC;"><br><br><br><br>
    <form class="container con1 shadow">
