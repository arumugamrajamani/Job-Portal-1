...
<link rel="stylesheet" href="css/sign-up-here.css">
</head>
<body>
    ...
    <div class="masthead" style="background-image: url('./image/fbg1.png');">
    	<br><br><br>
    	<div class="container">
      		<div class="card c1 border-dark " style="width: 6.5rem; height: 6.5rem">
        		<a href="signup.html">
        		<img src="image/employer.png" class="card-img-top img1" style="width:5rem" alt="Employer">
        		<div class="card-body"></a>
        		
          			<h6 class="card-title">Employer</h6>
       
        		</div>
      		</div>
      		<a href="signup1.html">
      		<div class="card c2 border-dark" style="width: 6.5rem; height: 6.5rem">
        		<img src="image/worker.png" class="card-img-top img2" style="width:5rem" alt="Employer"></a>
        		<div class="card-body">	
          			<h6 class="card-title">Worker</h6>
       
        		</div>
      		</div>

    		<div class="signup-here">
        		<h2 class="text-center">EMPLOYER SIGNUP</h2>
        		<form>
            		...
            		<div>
            			<input type="checkbox"> 
            			<label for="term">I agree to the term of service <br>and <a href="#">Privacy Policy</label><br>
