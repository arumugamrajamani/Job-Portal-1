    ...
    <div class="container"><br>
        <div class="masthead" style="background-image: url('./image/bg-footer.png');">
            <p>Please read these terms and conditions carefully before using Our Service.<br>
                ...
                ● “Affiliate” means an entity that controls, is controlled by, or is under common control with a party, whereas "control" means ownership of 50% or more of the shares, equity interest, or other securities entitled to vote for the election of directors or other managing authority.<br>
                ● “Account” means a unique account created for you to access our Service or parts of our<br>
                Service.<br>
                ...
                ● “Website” refers to [TECH-PLOYMENT], accessible from [WEBSITE_URL] <br>
